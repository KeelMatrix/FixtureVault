...
"@
    ...
    try {
        ...
        $structuredCases = @(
            ...
            [pscustomobject]@{ Name = "query-generic-literal-doubled-secret"; Fixture = "https://example.invalid/?token='''Canary123'''"; ExpectedExit = 1; ExpectedFinding = $true; Secret = "Canary123" },
            [pscustomobject]@{ Name = "query-generic-encoded-doubled-secret"; Fixture = 'https://example.invalid/?token=%27%27%27Canary123%27%27%27'; ExpectedExit = 1; ExpectedFinding = $true; Secret = "Canary123" },
            [pscustomobject]@{ Name = "query-generic-literal-quote-data"; Fixture = "https://example.invalid/?token=''''"; ExpectedExit = 1; ExpectedFinding = $true; Secret = "" },
            [pscustomobject]@{ Name = "query-generic-encoded-quote-data"; Fixture = 'https://example.invalid/?token=%27%27%27%27'; ExpectedExit = 1; ExpectedFinding = $true; Secret = "" },
            [pscustomobject]@{ Name = "query-api-key-literal-doubled-secret"; Fixture = "https://example.invalid/?api_key='''Canary123'''"; ExpectedExit = 1; ExpectedFinding = $true; Secret = "Canary123" },
            [pscustomobject]@{ Name = "query-api-key-encoded-doubled-secret"; Fixture = 'https://example.invalid/?api_key=%27%27%27Canary123%27%27%27'; ExpectedExit = 1; ExpectedFinding = $true; Secret = "Canary123" },
            [pscustomobject]@{ Name = "query-json-serialized-doubled-secret"; Fixture = ("https://example.invalid/?token='''Canary123'''" | ConvertTo-Json -Compress); ExpectedExit = 1; ExpectedFinding = $true; Secret = "Canary123" },
            [pscustomobject]@{ Name = "azure-account-key-suffix"; Fixture = 'AccountKey.Length=0'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "" },
            [pscustomobject]@{ Name = "azure-shared-access-key-suffix"; Fixture = 'SharedAccessKey.Enabled=false'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "" },
            [pscustomobject]@{ Name = "azure-shared-access-signature-suffix"; Fixture = 'SharedAccessSignature.Expires=0'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "" },
            [pscustomobject]@{ Name = "azure-prefixed-account-key-suffix"; Fixture = 'metadata|AccountKey.Length=0'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "" },
            [pscustomobject]@{ Name = "connection-string-quoted-space-keyword"; Fixture = 'Server=localhost;Application Name="display Pwd=Canary123";Integrated Security=true;'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "Canary123" },
            [pscustomobject]@{ Name = "connection-string-quoted-semicolon-keyword"; Fixture = 'Server=localhost;Application Name="display;Pwd=Canary123";Integrated Security=true;'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "Canary123" },
            [pscustomobject]@{ Name = "connection-string-json-quoted-space-keyword"; Fixture = ('Server=localhost;Application Name="display Pwd=Canary123";Integrated Security=true;' | ConvertTo-Json -Compress); ExpectedExit = 0; ExpectedFinding = $false; Secret = "Canary123" },
            [pscustomobject]@{ Name = "connection-string-sibling-password"; Fixture = 'Server=localhost;Application Name="display";Pwd=Canary123;'; ExpectedExit = 1; ExpectedFinding = $true; Secret = "Canary123" },
            [pscustomobject]@{ Name = "authorization-basic-marker-log-suffix"; Fixture = '[info] Authorization: Basic redacted; requestId=42'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "" },
            [pscustomobject]@{ Name = "authorization-bearer-marker-log-suffix"; Fixture = '[info] Authorization: Bearer [redacted]; requestId=42'; ExpectedExit = 0; ExpectedFinding = $false; Secret = "" },
            [pscustomobject]@{ Name = "authorization-bearer-real-log-suffix"; Fixture = '[info] Authorization: Bearer Canary123; requestId=42'; ExpectedExit = 1; ExpectedFinding = $true; Secret = "Canary123" },
            [pscustomobject]@{ Name = "authorization-json-marker-log-suffix"; Fixture = ('[info] Authorization: Bearer [redacted]; requestId=42' | ConvertTo-Json -Compress); ExpectedExit = 0; ExpectedFinding = $false; Secret = "" },
