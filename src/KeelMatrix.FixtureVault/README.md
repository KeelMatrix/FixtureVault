...
- `FV007` detects high-confidence structured credentials without disclosing matched values. See the [canonical detection grammar](https://github.com/KeelMatrix/FixtureVault/blob/main/docs/DETECTION_GRAMMAR.md) for ownership and boundary details.
