...
- Files are opened and read through bounded filesystem checks. Replaced links, special files, file growth/shrinkage, and resource-limit failures return exit code `2`; human-readable paths escape control characters while JSON preserves their actual path values.
