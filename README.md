...
High-confidence `FV007` independently detects structured credential values and never prints matched values. See the [canonical FV007 detection grammar](https://github.com/KeelMatrix/FixtureVault/blob/main/docs/DETECTION_GRAMMAR.md) for the complete ownership and boundary contract.
