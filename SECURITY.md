...
- Connection-string `Password`/`Pwd` detection honors doubled quote escapes and serialized string boundaries, ignores empty/whitespace-only/already-redacted values, and never emits matched values in console or JSON diagnostics.
